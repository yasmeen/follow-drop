...
const sismoConnectConfig: SismoConnectConfig = {
  ...
  vault: {
    ...
    impersonate: ["0x7a1d93cfd0ba6cee95f78e50def23e0a459d1160", "twitter:cryptodog", "0x4690556c739799383f8cE834a230995fD234e6c5"],
  },
};
    ...
    <>
      <main className={styles.main}>
        <h1>
          <b> FollowDrop</b>
          <br />
          Leveraging Social Networks for Tokenized Incentives
          <br/>
          Web2 Metrics Gated Airdrop
        </h1>

        {!isConnected && (
          <>
            <p>
              This is an innovative Web3 application that uses zk-SNARKs to ensure privacy while verifying user credentials.
              It interfaces with the Web3 Lens protocol to confirm a user's follower status and checks their ownership of a specific governance token.
        ...
        {isConnected && !responseBytes && (
          <>
            <p>Sismo Connect protects our airdrop from:</p>
            <br />
            <ul>
            ...
            <SismoConnectButton
              ...
              claims={[
                // {
                //   groupId: "0xc81c6f76e2d0444a67ad1e7a92172b5a"
                // },
                {
